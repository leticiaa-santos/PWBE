...
class Banco:
    ...
    def menu_opcoes(self): # menu para exibir opções
    ...
    def cadastrar_clientes(self): # método para cadastrar um cliente
        print("=============================== Banco ===========================")
    ...
    def encontrar_cliente(self, cpf): # método para encontrar um cliente pelo cpf
    ...
    def sacar(self): # método que permite o saque, mediante a verificação do saldo
    ...
    def depositar(self): # método que permite o depósito
    ...
    def transferir(self): # método que permite transferir para outra conta, com a colocação do cpf
