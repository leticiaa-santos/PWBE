...
class Triangulo:
    ...
    def verifica_triangulo(self):
        if self.lado_1 + self.lado_2 > self.lado_3 and self.lado_1 + self.lado_3 > self.lado_2 and self.lado_2 + self.lado_3 > self.lado_1: # condição para verificar se o triangulo é válido de acordo com o tamanho de seus lados
            print("Triângulo Válido")
        else:
            print("Triângulo inválido")

    def calcula_area(self):
        self.area = (self.base * self.altura) / 2 # calculo da area do triangulo
