...
class LojaVirtual:
    ...
    def menu(self): # menu de opções do sistema
    ...
    def cadastrar_produtos(self): # método que permite o cadastro de produtos
        print("=========================== Loja Virtual ===========================")
    ...
    def adicionar_carrinho(self): # método que permite adicionar um produto ao carrinho
    ...
    def ver_carrinho(self): # método que permite visualizar tudo que está no carrinho
        print("========================== Seu carrinho =============================")
        if self.carrinho:
